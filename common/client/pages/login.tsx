...
type getServerSidePropsResponse = { props: { csrfToken: Awaited<ReturnType<typeof getCsrfToken>> } };
...
const SignInPage: NextPage<getServerSidePropsResponse["props"]> = ({csrfToken}) => {
  ...
  return (
    <>
      <Formik
        ...
        onSubmit={async (values: { email: any; password: any; tenantKey: any; }, {setSubmitting}: any) => {
          ...
          <form onSubmit={formik.handleSubmit}>
            <div
              ...
              <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div className="text-red-400 text-md text-center rounded p-2" style={{background:"red", color:"white", padding:"0.5rem"}}>
                  {error}
                </div>
                <div className="mb-4">
                  <label
